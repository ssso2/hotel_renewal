...
function UrbanIsland(props) {

    const galleryImages = [
        { src: "../../img/sub/urban-01.jpg", alt: "Urban 1" },
        { src: "../../img/sub/urban-02.jpg", alt: "Urban 2" },
        { src: "../../img/sub/urban-03.jpg", alt: "Urban 3" },
        { src: "../../img/sub/urban-04.jpg", alt: "Urban 4" }
    ];
