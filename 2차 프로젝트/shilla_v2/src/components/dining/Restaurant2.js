...
const galleryImages = [
  ...
  // 소개 데이터
  const introData = {
    title: "정통 프렌치 레스토랑 <strong>콘티넨탈</strong>",
    description: `
      우아한 실내장식과 부드러운 조명, 전문적이고 세심한 직원 서비스 또한 소중한 사람과의 특별한 만남을 더욱 빛나게 합니다.
    `,
    highlights: [
      {
        title: "프렌치 정찬",
        ...
        세계적인 정상급 와인부터 희소한 와인까지 500여 종의 다채로운 셀렉션을 보유한 와인의 메카로도 유명합니다.`,
      },
    ],
  };
